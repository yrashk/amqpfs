...
-define(DEFAULT_RESPONSE_POLICIES,
        [{list_dir, ?DEFAULT_RESPONSE_COLLECT, ?DEFAULT_RESPONSE_REDUCE},
         ...
         {setxattr, ?DEFAULT_RESPONSE_COLLECT, ?DEFAULT_RESPONSE_REDUCE},
         {removexattr, ?DEFAULT_RESPONSE_COLLECT, ?DEFAULT_RESPONSE_REDUCE},
         {getxattr, ?DEFAULT_RESPONSE_COLLECT, ?DEFAULT_RESPONSE_REDUCE},
         {listxattr, ?DEFAULT_RESPONSE_COLLECT, ?DEFAULT_RESPONSE_REDUCE}
        ]).
